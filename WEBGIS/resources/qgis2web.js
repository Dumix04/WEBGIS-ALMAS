...
map.getView().fit([12526752.738381, -890470.918802, 12552378.179826, -883486.814195], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Persebaran Studio Musik </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (70 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini Menyajikan Persebaran Studio musik yang ada di kec.lowokwaru ';
            }
